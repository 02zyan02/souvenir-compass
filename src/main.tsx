...
type Product = { id: number; name: string; chinese_name: string; country: string; country_slug: string; price: string; category: string; image_url: string; tag: string; note: string; reference_url: string }
